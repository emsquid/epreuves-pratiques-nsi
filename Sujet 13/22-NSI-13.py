def rendu(somme_a_rendre:int)->list:
    ...
    assert type(somme_a_rendre) == int and somme_a_rendre > 0, "somme_a_rendre est un entier positif non nul"
    n1 = somme_a_rendre // 5
...
class File:
    ...
    def defile(self) :
        if not self.est_vide():
            ...
            while maillon.suivant.suivant != None : # on itere jusqu'a trouver l'avant premier element
