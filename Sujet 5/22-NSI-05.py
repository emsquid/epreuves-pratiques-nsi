def rechercheMinMax(tableau:list)->dict:
    ...
    if tableau == []: # si le tableau est vide on renvoie des None
...
class PaquetDeCarte:
    ...
    def getCarteAt(self, pos):
        ...
        assert type(pos) == int and 0 <= pos < 51, "le paquet contient 52 cartes, pos est un entier entre 0 et 51"
        return self.contenu[pos] # eventuellement (pos - 1) selon l'interpretation 
